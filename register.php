        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 m-auto">
                    <h3 class="text-center m-2">Create an account</h3>
                    <h4 class="text-center m-2" style="font-weight: normal;">Please enter your Mobile Number to create your account</h4>

                    <div class="login-form-container d-flex">
                        <form class="mx-auto" action="otp.php">
                            <div class="login-input-box d-flex">
                                <input name="mobile-number" value="+93" style="width: 40px; padding: 10px 4px;" disabled="">
                                <input type="text" name="msisdn" id="msisdn" maxlength="9" style="padding: 10px 0px;" required="">
                            </div>
