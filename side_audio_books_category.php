<div class="col-lg-3 col-12 order-2 order-lg-1">
    <div class="shop__sidebar">
        ...
        <aside class="widget__categories products--cat">
            <h3 class="widget__title">Audio Books Categories</h3>
           
            <ul>
                <li>
                    <a 
                        href="audio-books.php?category_id=<?php echo $category_id; ?>" 
                ...
                <?php
                    $query = "SELECT * FROM audiobook.categories";
                    // $query = "SELECT A.*, 
                    //             (SELECT B.id 
                    //             FROM ebook AS B 
                ...
                ?>
                    <li>
                        <a 
                            href="audio-books.php?category_id=<?= $category_id; ?>"
                            style="font-weight: <?= $_GET['category_id'] == $category_id ? 'bold' : 'normal' ?>; color: <?= $_GET['category_id'] == $category_id ? '#ef0029' : 'black' ?>">
                            <?php echo $category; ?>
                        </a>
                    </li>
